		...
		ResourceManagementWorld<Material>
{
	 ...
	 */
	void performUsageChange(String processID, String processInstanceID, String activityName, String activityInstanceId, String equipmentName, String occupantName, final String assemblyLineRef, EventType eventType) throws Exception;
